...
def post(request):
    try:
        ...
        if data == "failure":
            ...
            if request.method == "POST":
                ...
                for char in subscriberdata:
                    send_mail(
                        "Traveller Blog New Post Notification","Gopala Krishna posted new post in travellers blog","demomail224@gmail.com",
                        [char.email]
                    )
        ...
        return render(request,"post.html",{"message":"Try again", "blogdata":blogdata})
